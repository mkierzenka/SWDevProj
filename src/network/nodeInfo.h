...
class NodeInfo: public Object {
    public:
        ...
        bool equals(Object* o) override {
			...
			return otherNode
				&& ntohl(addr_.sin_family) == ntohl(otherNode->addr_.sin_family) //ntohl guarantees network byte order
				&& ntohl(addr_.sin_addr.s_addr) == ntohl(otherNode->addr_.sin_addr.s_addr)
				&& ntohl(addr_.sin_port) == ntohl(otherNode->addr_.sin_port);
        }
